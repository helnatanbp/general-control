...
select id                  as "Cód."
 ...
 create view vw_os_tecnico as 
 select ost.id           		as   "Cód."
       ,ost.id_os               as   "Cód. OS"
       ,t.id             		as   "Cód. Tecnico"
       ,t.nome           		as   "Nome Tecnico"
       ,ost.data         		as   "Data"
       ,ost.inicio_manha        as   "Início Manha"
       ,ost.termino_manha       as   "Termino Manha"
       ,ost.inicio_tarde        as   "Início Tarde"
       ,ost.termino_tarde       as   "Termino Tarde"
       ,descricao_servico       as "Descrição do Serviço"
    from os_tecnico ost inner join tecnico t on (ost.id_tecnico = t.id); 
    
 create view vw_os_material as 
 select osm.id           		as   "Cód."
       ,osm.id_os               as   "Cód. OS"
       ,m.id             		as   "Cód. Material"
       ,m.descricao      		as   "Descrição do Material"
       ,osm.quantidade         	as   "Quantidade"       
    from os_material osm inner join material m on (osm.id_material = m.id);    

...
resourcestring
  ...
  //Os Tecnico
  STR_OS_TECNICO_HORARIO_INVALIDO   = 'ERRO. Início manhã não pode ser maior que termino manhã';
  STR_OS_TECNICO_HORARIO_INVALIDO_1 = 'ERRO. Termino manhã não pode ser maior que inicio tarde';
  STR_OS_TECNICO_HORARIO_INVALIDO_2 = 'ERRO. Inicio tarde não pode ser maior que termino tarde';

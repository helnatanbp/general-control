...
uses
  ...
  UOsTecnico in 'Modelo\Persistencia\UOsTecnico.pas',
  URepositorioOsTecnico in 'Modelo\Persistencia\URepositorioOsTecnico.pas',
  UOsMaterial in 'Modelo\Persistencia\UOsMaterial.pas',
  URepositorioOsMaterial in 'Modelo\Persistencia\URepositorioOsMaterial.pas';
